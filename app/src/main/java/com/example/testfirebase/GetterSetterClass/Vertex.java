...
public class Vertex {
    ...
    public Vertex(String vertex_id, String vertex_name, String vertex_lat, String vertex_long, String vertex_number, String vertex_type, String vertex_building_name) {
